...
Status: Updated for DeepVol-16 browser-smoke validation of wallet-gated UP/DOWN primitive execution and documented missing-wallet-extension blocker; RANGE remains disabled.
