...
For DeepVol direction and binary-leg requirements, see [DEEPVOL_PRODUCT_DIRECTION.md](./DEEPVOL_PRODUCT_DIRECTION.md), [DEEPVOL_PRIMITIVES_AND_RECEIPTS.md](./DEEPVOL_PRIMITIVES_AND_RECEIPTS.md), [DEEPVOL_MVP_SCOPE.md](./DEEPVOL_MVP_SCOPE.md), [DEEPVOL_FRONTEND_MVP.md](./DEEPVOL_FRONTEND_MVP.md), [DEEPVOL_BROWSER_BUY_VALIDATION.md](./DEEPVOL_BROWSER_BUY_VALIDATION.md), [DEEPVOL_REDEEM_AND_SETTLEMENT_FLOW.md](./DEEPVOL_REDEEM_AND_SETTLEMENT_FLOW.md), [DEEPVOL_REDEEM_PREFLIGHT_VALIDATION.md](./DEEPVOL_REDEEM_PREFLIGHT_VALIDATION.md), [DEEPVOL_PROTOCOL_ARCHITECTURE.md](./DEEPVOL_PROTOCOL_ARCHITECTURE.md), [DEEPVOL_MOVE_RECEIPT_CONTRACT.md](./DEEPVOL_MOVE_RECEIPT_CONTRACT.md), [DEEPVOL_CONTRACT_BUILD_VALIDATION.md](./DEEPVOL_CONTRACT_BUILD_VALIDATION.md), [DEEPVOL_BINARY_LEG_INTEGRATION.md](./DEEPVOL_BINARY_LEG_INTEGRATION.md), [DEEPVOL_BINARY_MINT_TESTNET_VALIDATION.md](./DEEPVOL_BINARY_MINT_TESTNET_VALIDATION.md), [DEEPVOL_TESTNET_PUBLISH_RESULT.md](./DEEPVOL_TESTNET_PUBLISH_RESULT.md), [DEEPVOL_BUY_MOVE_RECEIPT_TESTNET_VALIDATION.md](./DEEPVOL_BUY_MOVE_RECEIPT_TESTNET_VALIDATION.md), and [ADR/0003-pivot-to-deepvol-btc-move.md](./ADR/0003-pivot-to-deepvol-btc-move.md).
...
| DeepVol guided binary redeem | Guided non-custodial redeem is the recommended MVP exit path after browser buy validation. DeepVol-11 source-confirmed `predict::redeem<DUSDC>` / `predict::redeem_permissionless<DUSDC>`, payout quote source, event fields, and quoteable-oracle behavior, then read/preflighted the known browser receipt without execution. | Source-confirmed and devInspect-preflighted; real execution pending DeepVol-12 approval | Source branch, validation script, devInspect, future event parsing, direct before/after position readback | Current known manager-level quantities were UP `20000` and DOWN `20000`; selected receipt quantity was `10000`; devInspect redeem preflight passed for both receipt-scoped legs. Payout and market state remain `MUST CONFIRM AT RUNTIME`; production settlement still requires event/readback reconciliation. |
...
| 13 | `predict::redeem<DUSDC>` / `predict::redeem_permissionless<DUSDC>` | Redeem binary positions for guided settlement | Source-confirmed and devInspect-preflighted by DeepVol-11 for the known browser receipt; real execution pending DeepVol-12 approval |
