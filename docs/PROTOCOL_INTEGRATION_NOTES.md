...
Status: Updated with confirmed official DeepBook Predict Testnet values, DeepVol-16 browser-smoke validation of primitive execution gates, and the missing-wallet-extension blocker for real UP/DOWN primitive execution.
