...
Status: Updated for DeepVol-20: fresh BTC MOVE buy validated with active VolSeries. create_series is permissionless but not mintability proof. Fresh BTC MOVE VolSeries creation and buy readiness require mintable range validation. See DEEPVOL_ACTIVE_MOVE_SERIES.md, DEEPVOL_MINTABLE_MOVE_RANGE.md, and DEEPVOL_FRESH_MOVE_BUY_VALIDATION.md.
