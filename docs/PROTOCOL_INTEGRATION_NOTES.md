...
For DeepVol direction and binary-leg requirements, see [DEEPVOL_PRODUCT_DIRECTION.md](./DEEPVOL_PRODUCT_DIRECTION.md), [DEEPVOL_PRIMITIVES_AND_RECEIPTS.md](./DEEPVOL_PRIMITIVES_AND_RECEIPTS.md), [DEEPVOL_MVP_SCOPE.md](./DEEPVOL_MVP_SCOPE.md), [DEEPVOL_FRONTEND_MVP.md](./DEEPVOL_FRONTEND_MVP.md), [DEEPVOL_BROWSER_BUY_VALIDATION.md](./DEEPVOL_BROWSER_BUY_VALIDATION.md), [DEEPVOL_REDEEM_AND_SETTLEMENT_FLOW.md](./DEEPVOL_REDEEM_AND_SETTLEMENT_FLOW.md), [DEEPVOL_PROTOCOL_ARCHITECTURE.md](./DEEPVOL_PROTOCOL_ARCHITECTURE.md), [DEEPVOL_MOVE_RECEIPT_CONTRACT.md](./DEEPVOL_MOVE_RECEIPT_CONTRACT.md), [DEEPVOL_CONTRACT_BUILD_VALIDATION.md](./DEEPVOL_CONTRACT_BUILD_VALIDATION.md), [DEEPVOL_BINARY_LEG_INTEGRATION.md](./DEEPVOL_BINARY_LEG_INTEGRATION.md), [DEEPVOL_BINARY_MINT_TESTNET_VALIDATION.md](./DEEPVOL_BINARY_MINT_TESTNET_VALIDATION.md), [DEEPVOL_TESTNET_PUBLISH_RESULT.md](./DEEPVOL_TESTNET_PUBLISH_RESULT.md), [DEEPVOL_BUY_MOVE_RECEIPT_TESTNET_VALIDATION.md](./DEEPVOL_BUY_MOVE_RECEIPT_TESTNET_VALIDATION.md), and [ADR/0003-pivot-to-deepvol-btc-move.md](./ADR/0003-pivot-to-deepvol-btc-move.md).
...
DeepVol browser wallet buy is now validated on Testnet. The receipt remains non-custodial: the `MoveReceipt` records metadata/linkage, while the UP and DOWN binary positions remain in the user's `PredictManager`. Future redeem work must confirm Predict binary redeem signatures, payout quote/readback behavior, event fields, and claim/expiry handling before coding; guided MVP redeem must not imply Profit Fee enforcement, custody, withdraw authority, or mainnet support.
...
| DeepVol guided binary redeem | Guided non-custodial redeem is the recommended MVP exit path after browser buy validation. | MUST CONFIRM BEFORE CODING | Source branch, generated bindings, devInspect, event parsing, direct before/after position readback | Confirm exact `predict::redeem<DUSDC>` / `predict::redeem_permissionless<DUSDC>` call shape, payout quote source, event fields, and claim/expiry behavior before adding browser redeem builders. |
