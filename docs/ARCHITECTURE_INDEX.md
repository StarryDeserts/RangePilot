...
| DeepVol Predict primitives frontend | DeepVol product direction, primitives and receipts, primitive execution policy, Predict primitives frontend, primitive quote/preflight, primitive active market discovery, RANGE mintability diagnostics, MVP scope, frontend MVP, protocol integration notes, entrypoint bindings plan |
